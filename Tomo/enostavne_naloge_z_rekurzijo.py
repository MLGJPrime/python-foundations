...
def cantor(n):
    if n == 0:
        return '*'
    smaller = cantor(n - 1)
    return smaller + len(smaller) * ' ' + smaller
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo1Nzg4LCJ1c2VyIjo2MTkzfQ:1qictf:_znLJVnK7O_5nuSHO5B8zn8XSrunOO2i1ZLS-yNHHHI"
        try:
            test_data = [
                ("""fakulteta(3)""", 6),
                ("""fakulteta(5)""", 120),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo1Nzg5LCJ1c2VyIjo2MTkzfQ:1qictf:oUzLskx9oRw2kKph7F2jdgs_LhP4GiGBrBlIR9rTV0M"
        try:
            test_data = [
                ("""gcd(31, 6)""", 1),
                ("""gcd(315, 0)""", 315),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo1NzkwLCJ1c2VyIjo2MTkzfQ:1qictf:CoPH-QfkljjCW7iubIZ51DxROJMu7eJygyo3H5edqOA"
        try:
            test_data = [
                ("cantor(0)", "*"),
                ("cantor(1)", "* *"),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo1NzkxLCJ1c2VyIjo2MTkzfQ:1qictf:iZXxUKZXp2FK-Sqov2pceeGTtC1gpG9k0hL56TtLjjk"
        try:
            test_data = [
                ("""fibonacci(1)""", 1),
                ("""fibonacci(3)""", 2),
